...
def get_insured_info(blocks, block_number):
    dict = {}
    i = block_number
...
def get_agent_info(blocks, block_number):
    dict = {}
    i = block_number
...
def get_company_info(blocks, block_number):
    i = block_number
    dict = {}
...
def get_driver_info(blocks,block_number):
    dict = {}
    list = []
    i=block_number
...
for (root, dirs, file) in os.walk(path):
    for f in file:
        if '.pdf' in f:
            ...
            page = doc[0]
            blocks = page.getText("dict")['blocks']
            i = check_blocks(blocks)
            print("----INSURED INFO-----")
            Insured_info = get_insured_info(blocks, i)
            print(Insured_info)
            print("----AGENT INFO-----")
            Agent_info = get_agent_info(blocks, i)
            print(Agent_info)
            print("----COMPANY INFO----")
            Company_info = get_company_info(blocks, i)
            print(Company_info)
            print("----Driver's INFO----")
            driver_info = get_driver_info(blocks,i)
            print(driver_info)
            print("------------------------------------------------------------")
            print("------------------------------------------------------------")
